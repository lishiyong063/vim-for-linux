...
" show list of errors and warnings on the current file  \e 显示出错误
...
" mappings to move blocks in 4 directions shift+ 键盘中的上下左右 
...
autocmd FileType python map <C-n>  :lne<CR>
autocmd FileType python map <F3> :lne<CR>
...
" 设置# 搜索高亮颜色
hi Search guifg=#000000 ctermfg=16 guibg=#8cffba ctermbg=121


" sudo apt-get install vim-gnome vim 中复制到系统剪切版 ctrl+c 绑定复制
" ctrl+ V 绑定粘贴
vmap <c-c> "+y  
nmap <s-v> "+gp
" 退出vim 后终端界面停留在vim中的内容
" set t_ti= t_te=
